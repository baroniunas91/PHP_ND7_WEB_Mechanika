...
<body style="background-color: blue">
    <form action="" method="get">
        <button name="a" href="http://localhost/BIT/ND7_WEB_Mechanika/blue.php" type="submit" style="color: black; background-color: white; padding: 5px 20px; border-radius: 5px; border: 1px solid black;">Nuoroda į save</button>
    </form>
</body>

<?php
if (isset($_GET['a'])) {
    header('Location: http://localhost/BIT/ND7_WEB_Mechanika/red.php');
    die();
}
